                ...
                @if (auth()->user()->hasRole('adminprov') || auth()->user()->is_allowed_swmaps)
                    <li class="nav-item">
                        <a class="nav-link {{ Route::currentRouteName() == 'market-upload' ? 'active' : '' }}"
                            ...
                            <span class="nav-link-text ms-1">Upload Sentra Ekonomi</span>
                        </a>
                    </li>
                @endif
            @endhasrole
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Suplemen</h6>
            </li>
            <li class="nav-item">
            ...
            {{-- @hasrole('adminprov')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'suplemen/download') == true ? 'active' : '' }}"
                        ...
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-book text-sm opacity-10" style="color: #6d03ef"></i>
                        </div>
                        <span class="nav-link-text ms-1">Assignment Wilkerstat</span>
                    </a>
                </li>
            @endhasrole --}}
            @haspermission('edit_business')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'anomali') == true ? 'active' : '' }}"
                        ...
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-table text-sm opacity-10" style="color: #6d03ef"></i>
                        </div>
                        <span class="nav-link-text ms-1">List Anomali</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'duplicate') == true ? 'active' : '' }}"
                        href="/maps/duplicate">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-layer-group text-sm opacity-10 text-info"></i>
                        </div>
                        <span class="nav-link-text ms-1">Data Duplikat</span>
                    </a>
                </li>
            @endhaspermission
            @hasrole('adminkab|adminprov')
