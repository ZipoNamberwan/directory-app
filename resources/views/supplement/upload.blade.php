...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Upload Project Suplemen'])
    <div class="container-fluid py-4">
        ...
        <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
                <h6 class="text-capitalize">Upload Project Suplemen</h6>
                {{-- <p class="text-sm mb-0">
                    <span>Berikut rekap semua assignment direktori usaha</span>
                </p> --}}
            </div>
            <div class="card-body p-3">
                <form id="formupdate" autocomplete="off" method="post" action="/suplemen/upload" class="needs-validation"
        ...
        <div class="card mt-2">
            ...
            <div class="card-body">
                <div>
                    <button id="refresh" onclick="renderTable()" class="btn btn-success btn-sm p-2">Refresh</button>
                </div>
                <div class="row">
                    <div class="col-md-3">
...
@push('js')
    ...
    <script>
        ...
        function renderTable() {
            ...
            table.ajax.url('/suplemen/upload/data?' + filterUrl).load();
        }
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (type === 'display') {
                            return `
                        <form class="my-2" action="/suplemen/download/swmap" method="POST">
                            @csrf
