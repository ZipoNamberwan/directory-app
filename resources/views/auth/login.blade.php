        ...
        <section>
            <div class="page-header min-vh-100">
              ...
              background-size: cover;">
                                ...
                                <h1 class="mt-5 text-white font-weight-bolder position-relative">"Ken Dedes"</h4>
                                <h4 class="text-white position-relative">Kendali Pemutakhiran Direktori Perusahaan.</p>
                            </div>
                        </div>
                    </div>
                </div>
