        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0 mt-2" style="height: auto;">
                    ...
                    <select id="statusUpdate" name="statusUpdate" class="form-control" data-toggle="select" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0 mt-2" style="height: auto;">
                    <div class="row">
                        <div class="col-md-12">
                            <label class="form-control-label">Kecamatan <span class="text-danger">*</span></label>
                            <select id="subdistrictAdd" name="subdistrictAdd" class="form-control" data-toggle="select">
                        ...
                        <div class="col-md-12">
                            <label class="form-control-label">Desa <span class="text-danger">*</span></label>
                            <select id="villageAdd" name="villageAdd" class="form-control" data-toggle="select" name="village"></select>
                        </div>
                        <div class="col-md-12">
                            <label class="form-control-label">SLS <span class="text-danger">*</span></label>
                            <select id="slsAdd" name="slsAdd" class="form-control" data-toggle="select"></select>
                            <p id="slsAddError" style="display: none; font-size: 0.6rem; color:red"></p>
                        </div>
                        <div class="col-md-12">
                            <label class="form-control-label">Nama Usaha <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" placeholder="Nama Usaha" id="nameAdd" name="nameAdd">
        ...
        if (id != null) {
            $.ajax({
                ...
                success: function(response) {
                    $(villageSelector).empty().append(`<option value="0" disabled selected> -- Filter Desa -- </option>`);
                    $(slsSelector).empty().append(`<option value="0" disabled selected> -- Filter SLS -- </option>`);

                    response.forEach(element => {
                        $(villageSelector).append(`<option value="${element.id}" ${selectedvillage == element.id ? 'selected' : ''}>[${element.short_code}] ${element.name}</option>`);
                    });
                }
            });
        } else {
        ...
        if (id != null) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.forEach(element => {
                        $(slsSelector).append(`<option value="${element.id}" ${selectedsls == element.id ? 'selected' : ''}>[${element.short_code}] ${element.name}</option>`);
                    });
                }
            });
        } else {
