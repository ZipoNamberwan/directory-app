            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-2 text-uppercase font-weight-bold">Pemutakhiran Direktori Sampai Level SLS</p>
                                <h5 class="font-weight-bolder">
                                    {{$reportData['sls']['percentage']}}%
                                </h5>
                                <p class="mb-0">
                                    <span class="text-sm"><strong class="text-info">{{$reportData['sls']['updated']}}/{{$reportData['sls']['total']}}</strong> sudah dimutakhirkan</span>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-2 text-uppercase font-weight-bold">Pemutakhiran Direktori Sampai Level SLS</p>
                                <h5 class="font-weight-bolder">
                                    {{$reportData['non_sls']['percentage']}}%
                                </h5>
                                <p class="mb-0">
                                    <span class="text-sm"><strong class="text-success">{{$reportData['non_sls']['updated']}}/{{$reportData['non_sls']['total']}}</strong> sudah dimutakhirkan</span>
                                </p>
                            </div>
                        </div>
                        <div class="col-4 text-end">
