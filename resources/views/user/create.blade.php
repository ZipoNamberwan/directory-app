...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body pt-1">
            <form id="formupdate" autocomplete="off" method="post" action="{{$user == null ? '/users' : '/users/'.$user->id}}" class="needs-validation" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mt-3">
                        <label class="form-control-label" for="firstname">Nama <span class="text-danger">*</span></label>
                        <input type="text" name="firstname" class="form-control @error('firstname') is-invalid @enderror"
                            value="{{ @old('firstname', $user != null ? $user->firstname : '') }}" id="firstname" placeholder="Nama Lengkap">
                        @error('firstname')
                ...
                <div class="row">
                    <div class="col-md-6 mt-3 mb-3">
                        ...
                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="password"
                            value="{{ @old('password', $user != null ? $user->password : '') }}" autocomplete="new-password" placeholder="Password">
                        @error('password')
                        <div class="error-feedback">
                            {{ $message }}
                        </div>
