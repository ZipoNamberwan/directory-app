...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="modal fade" id="updateNewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header pb-1">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0 mt-2" style="height: auto;">
                        <div class="row">
                            <div class="col-md-4">
                                <label class="form-control-label mb-0">Kecamatan <span
                            ...
                            <div class="col-md-12">
                                <label class="form-control-label">Nama Usaha <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Nama Usaha" id="name-add"
                                    name="name-add">
                ...
                if (id != null) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            `
                                    ...
                                    button = `
                            <button data-row='${escapeJsonForHtml(JSON.stringify(item))}' onclick="onDeleteModal(this)" class="px-2 py-1 m-0 btn btn-icon btn-outline-danger btn-sm" type="button">
                    ...
                    `
                            ...
                            if (response.length == 0) {
                                resultDiv.innerHTML =
                                    `<p class="text-small text-warning">Tidak ada direktori di SLS ini</p>`
                            }
                        },
